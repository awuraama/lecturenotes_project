...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="index.php#categories" class="nav-item nav-link">Courses</a>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Get In Touch</h5>
                    <p class="mb-4">We are happy to help! If you're looking for contact information or details about
                        ACrew's online Services!, feedback! or suggestions!... <b>We dey for you</b></p>
                        <p>Together we can make learning more accessible and effective</p>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h5>Email</h5>
                            <p class="mb-0">hannahmaamleyosae@gmail.com</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit"><a
                                        href="mailto:hannahmaamleyosae@gmail.com" class="text-decoration-none"
    ...
    <!-- Footer Start -->
    <div class="container-fluid text-light footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s" style="background-color: black;">
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <h4 class="text-white mb-3">Quick Link</h4>
                    <p><a class="text-light" href="about.php">About Us</a></p>
                    <p><a class="text-light" href="index.php#categories">Courses</a></p>
